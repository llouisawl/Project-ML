...
@app.route("/")
def index():
    return render_template("index.html", symptoms_list=symptoms_dict)

@app.route('/predict', methods=['POST'])
def home():
    # Ambil symptom yang dipilih
    selected_symptoms = request.form.getlist('symptoms')

    if not selected_symptoms:
        message = "Please select symptoms to proceed"
        return render_template('index.html', message=message, symptoms_list=symptoms_dict)
